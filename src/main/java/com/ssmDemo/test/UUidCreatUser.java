...
//		departmentMapper.insertSelective(new Department(null, "测试部"));
        ...
        //2、生成员工数据，测试员工插入
//        employeeMapper.insertSelective(new Employee(null, "Bob", "M", "Bob@hyf.com", 1));
...
//            mapper.insertSelective(new Employee(null,uid, "M", uid+"@hyf.com", 1));
        }
